        ...
        <div className="grid gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                  <p className="text-sm text-slate-500">框架</p>
                ...
                <div>
                  <p className="text-sm text-slate-500">AI模型</p>
                  <p className="font-medium">Doubao Pro</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>系统各模块状态</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <h4 className="font-medium mb-2">1. 素材采集</h4>
              ...
              <Separator />
              <div>
                <h4 className="font-medium mb-2">2. 产品管理</h4>
                <p className="text-sm text-slate-600">
              ...
              <Separator />
              <div>
                <h4 className="font-medium mb-2">3. 话术生成</h4>
                <p className="text-sm text-slate-600">
              ...
              <Separator />
              <div>
                <h4 className="font-medium mb-2">4. 知识库管理</h4>
                <p className="text-sm text-slate-600">
